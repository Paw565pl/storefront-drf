...
class TestListProducts:
    def test_if_products_does_not_exist_returns_200(self, api_client):
    ...
    def test_if_products_exist_returns_200(self, api_client, create_product):
        response = api_client.get("/api/products/")
        results = response.data.get("results")
...
class TestCreateProduct:
    ...
    def test_if_data_is_invalid_returns_400(self, admin_api_client):
        response = admin_api_client.post("/api/products/", {})

        assert response.status_code == status.HTTP_400_BAD_REQUEST

    def test_if_data_is_valid_returns_201(self, admin_api_client, create_collection):
...
class TestUpdateProduct:
    def test_if_user_is_anonymous_returns_401(self, api_client, create_product):
        product_id = create_product.id
        response = api_client.put(f"/api/products/{product_id}/", {})
    ...
    def test_if_user_is_not_admin_returns_403(
        ...
        product_id = create_product.id
        response = authenticated_api_client.put(f"/api/products/{product_id}/", {})

        assert response.status_code == status.HTTP_403_FORBIDDEN

    def test_if_product_does_not_exist_returns_404(self, admin_api_client):
        response = admin_api_client.put("/api/products/1/", {})

        assert response.status_code == status.HTTP_404_NOT_FOUND

    def test_if_data_is_invalid_returns_400(self, admin_api_client, create_product):
        product_id = create_product.id
        response = admin_api_client.put(f"/api/products/{product_id}/", {})
...
class TestPartialUpdateProduct:
    def test_if_user_is_anonymous_returns_401(self, api_client, create_product):
        product_id = create_product.id
        response = api_client.patch(f"/api/products/{product_id}/", {})
    ...
    def test_if_user_is_not_admin_returns_403(
        ...
        product_id = create_product.id
        response = authenticated_api_client.patch(f"/api/products/{product_id}/", {})

        assert response.status_code == status.HTTP_403_FORBIDDEN

    def test_if_product_does_not_exist_returns_404(self, admin_api_client):
        response = admin_api_client.patch("/api/products/1/", {})
    ...
    def test_if_data_is_valid_returns_200(
        self, admin_api_client, create_product, create_collection
    ):
        product_id = create_product.id
        payload = {
            "title": "test",
...
class TestDeleteProduct:
    ...
    def test_if_user_is_not_admin_returns_403(
        ...
        product_id = create_product.id
        response = authenticated_api_client.delete(f"/api/products/{product_id}/")

        assert response.status_code == status.HTTP_403_FORBIDDEN

    def test_if_product_does_not_exist_returns_404(self, admin_api_client):
        response = admin_api_client.delete("/api/products/1/")

        assert response.status_code == status.HTTP_404_NOT_FOUND

    def test_if_user_is_admin_returns_204(self, create_product, admin_api_client):
        product_id = create_product.id
